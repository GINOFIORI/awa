        ...
        <div class="ibox-content" style="background-color: #A7BEE7;">
          <form id="filtros"
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                 <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                    <div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'>
                      <label  for="codCliente" style="color: black;">Cliente</label>
                    </div>
              ...
              <div class="col-sm-6">
                <div class="col-sm-6 b-r"><label style="color: black;">Fecha Desde</label><input id="fechaDesde"
                                                                                                 name="fechaDesde"
                ...
                <div class="col-sm-6 "><label style="color: black;">Fecha Hasta</label>   <input id="fechaHasta"
                                                                                                 name="fechaHasta"
                                                                                                 value="<?php if(isset($fechaHasta)) echo $_REQUEST['fechaHasta']; ?>"
                                                                                                 style = "height: 22px; font-size: 9pt;"    type="Date" 
                                                                                                 class="form-control">
                </div>
                <div class="col-sm-12 "><label style="padding-top: 5px; color: black;">Orden</label>
