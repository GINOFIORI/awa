...
<html lang="en">
  <head>
    ...
    <title>NeoSistemas SRL | Reporte de Ventas de Productos </title>
      ...
      <div class="panel panel-default" style="border-color: #A7BEE7; background-color: #A7BEE7; border-radius: 0px 0px 0px 0px " >
        <div class="ibox-title" style="background-color:#2F4050;" data-toggle="collapse" data-parent="#accordion" href="#collapse1">          
          <h5 style="color:#DFE4ED;">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" style="color: #DFE4ED">Reporte de Ventas de Productos</a>
          </h5>
        </div>
              ...
              <form id="filtros" name="filtros" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" >
                <div class="row" style="height: auto;">
                 <div class="height_1 col-xs-12 col-sm-5 col-md-5 col-lg-5 b-r"  style=" padding: 0px; line-height: 2;">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="padding: 0px;">
                        <div class='col-xs-12 col-sm-5 col-md-5 col-lg-5' style='text-align: left; padding-left: 0; padding-right: 0;'>
                          <label style="color: black; font-size: 9pt">Fecha Desde</label>
                        </div>
                        <div class='col-xs-12 col-sm-7 col-md-7 col-lg-7' style="padding-left: 0; padding-right: 0; text-align: left;">
                          <div class='input-group col-xs-12 col-sm-11 col-md-11 col-lg-11' style="display: inline-block;" > 
                          <input id    = "fechaDesde"
                                 name  = "fechaDesde"
                                 value = "<?php if(!isset($fechaDesde)) echo  date("Y-m-d"); ?>"
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="padding: 0px;">
                        <div class='padMargen col-xs-12 col-sm-5 col-md-5 col-lg-5' style='text-align: left; padding-right: 0; padding-left: 3px'>
                          <label style="color: black; font-size: 9pt">Fecha Hasta</label>
                        </div>
                        <div class='col-xs-12 col-sm-7 col-md-7 col-lg-7' style="padding-left: 0; padding-right: 0; text-align: left;">
                          <div class="input-group col-xs-12 col-sm-11 col-md-11 col-lg-11" style="margin: 0px; display: inline-block;">
                            <input id    = "fechaHasta"
                                   name  = "fechaHasta"
                                   value = "<?php if(!isset($fechaHasta)) echo  date("Y-m-d"); ?>"
                                   style = "height: 22px; font-size: 9pt;  padding-bottom: 0px !important; padding-top: 0px !important"    
                                   type  = "Date" 
                                  class = "form-control unstyled">
                          </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="pad16 col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 0px; padding-left: 0px;">
                        <div class='padMargen width col-xs-12 col-sm-12 col-md-3 col-lg-3' style='text-align: left; padding-right: 0; padding-left: 0px;'>
                          <label style="color: black; font-size: 9pt;">Tipo de Corte</label>
                        </div>
                        <div class='col-xs-12 col-sm-8 col-md-8 col-lg-8' style="padding-left: 0; padding-right: 0; text-align: left;">
                          <div class="input-group col-xs-12 col-sm-9 col-md-9 col-lg-9 col-md-offset-1" style="margin: 0px;">
                           <select style="font-size: 9pt; height: 22px; padding-top: 0; padding-bottom: 0;" name="tipoCorte" class="form-control" id="tipoCorte">
                              <option <?php if((isset($tipoCorte)) && ($tipoCorte=="1"))echo 'selected="selected"'; ?> value="1">Corte por Familias</option>
                              <option <?php if((isset($tipoCorte)) && ($tipoCorte=="2"))echo 'selected="selected"'; ?> value="2">Corte por Familias - Grupos</option>
                              <option <?php if((isset($tipoCorte)) && ($tipoCorte=="2"))echo 'selected="selected"'; ?> value="3">Corte por Familias - Grupos - Artículos</option>
                          </select>
                          </div>
                        </div>
                      </div>
                ...
                <div class="control-group pad15" >
                  <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" id="recuperar"> 
                    <button id="recuperar" 
                            ...
                            type="button"
                            onclick="recuperarVentasProductos(<?php echo $codRol; ?>)">
...
<div class="row">
  <table class="table table-hover tablaGeneral" id="listadoVtasProd">
    <thead style="background-color: lightgrey;">
      <tr style="height: 33.33px;">
        ...
        <th class="text-center" id="encabezado7"> <strong><strong></th>
      </tr>
    </thead>
    <tbody>
    </tbody>
...
<script type="text/javascript" src="../../ventas/js_ventas/funcionesReporteVentasProductos.js"></script>
