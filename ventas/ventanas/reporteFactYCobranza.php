...
<html lang="en">
  <head>
    ...
    <title>NeoSistemas SRL | Reporte de Facturación y Cobranza </title>
      ...
      <div class="panel panel-default" style="border-color: #A7BEE7; background-color: #A7BEE7; border-radius: 0px 0px 0px 0px " >
        <div class="ibox-title" style="background-color:#2F4050;" data-toggle="collapse" data-parent="#accordion" href="#collapse1">          
          <h5 style="color:#DFE4ED;">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" style="color: #DFE4ED">Reporte de Facturación y Cobranza</a>
          </h5>
        </div>
                        ...
                        <div class='col-xs-12 col-sm-8 col-md-8 col-lg-8' style="padding-left: 0; padding-right: 0; text-align: left;">
                          <div class="input-group col-xs-12 col-sm-9 col-md-9 col-lg-9 col-md-offset-1" style="margin: 0px;">
                           <select style="font-size: 9pt; height: 22px; padding-top: 0; padding-bottom: 0;" name="tipoCorte" class="form-control" id="tipoCorte">
                              <option <?php if((isset($tipoCorte)) && ($tipoCorte=="1"))echo 'selected="selected"'; ?> value="1">Listado de Facturación</option>
                              <option <?php if((isset($tipoCorte)) && ($tipoCorte=="2"))echo 'selected="selected"'; ?> value="2">Listado de Cobranza</option>
                          </select>
                          </div>
                        </div>
                      </div>
                ...
                <div class="control-group pad15" >
                  <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" id="recuperar"> 
                    <button id="recuperar" 
                            ...
                            type="button"
                            onclick="recuperarListado(<?php echo $codRol; ?>)" >
  ...
  <div class="row">
    <table class="table table-hover tablaGeneral" id="listado">
...
<script type="text/javascript" src="../../ventas/js_ventas/funcionesCtaCte.js"></script>
<script type="text/javascript" src="../../ventas/js_ventas/funcionesReporteFactYCobranza.js"></script>
